                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-end"
                                                            ...
                                                            <c:if
                                                                ...
                                                                <li><a class="dropdown-item"
                                                                        href="${pageContext.request.contextPath}/Presentation/dashboard.jsp">Quản
                                                                        lý hệ thống</a></li>
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <div class="single-gallery mb-30">
                                        ...
                                        <div class="gallery-img size-img"
                                            style="background-image: url(img/gallery/gallery1.png);"></div>
                                    </div>
                                </div>
                                <div class="col-lg-8 col-md-6 col-sm-6">
                                    <div class="single-gallery mb-30">
                                        <div class="gallery-img size-img"
                                            style="background-image: url(img/gallery/gallery2.png);"></div>
                                    </div>
                                </div>
                                <div class="col-lg-8 col-md-6 col-sm-6">
                                    <div class="single-gallery mb-30">
