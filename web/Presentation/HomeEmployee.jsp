    ...
    <head>
        ...
        <style>
            ...
            .single-team:hover .team-caption {
                background-color: transparent !important; /* hoặc màu mặc định */
            }
                    ...
                    <div class="container-fluid">
                        <div class="row align-items-center" style="min-height: 80px;">
                            ...
                            <div class="col-xl-2 col-lg-2 col-md-2 d-flex align-items-center">
                                <div class="logo">
                                    <a href="${pageContext.request.contextPath}/homeemployee"><img src="${pageContext.request.contextPath}/Presentation/img/logo/logo.png" alt=""></a>
                                </div>
                            </div>
                            <!-- Menu -->
                            ...
                            <c:choose>
                                <c:when test="${not empty sessionScope.staff}">
                                    <div class="header-user-info">
                                        <span>Xin chào, ${sessionScope.staff.email}</span>
                                        <div class="dropdown">
                                            <a href="#"
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end"
                                                ...
                                                <c:if
                                                    test="${sessionScope.staff.roleId == 1 || sessionScope.staff.roleId == 2}">
                                                    <li>
                                ...
                                <c:otherwise>
                                    <div class="header-user-info">
                                        <a href="${pageContext.request.contextPath}/login-employee"
                ...
                <div class="col-xl-2 col-lg-2 col-md-4 col-sm-5">
                    <div class="single-footer-caption mb-50">
                        <div class="footer-tittle">
                            <h4>Company</h4>
                            <ul>
                                <li><a href="${pageContext.request.contextPath}/homeemployee">Home</a></li>
